...
<body>
<h1><fmt:message key="editproduct.heading"/></h1>
<form:form method="post" modelAttribute="product" action="editproduct.htm">
  ...
  <br>
  <input type="submit" align="center" value="Update Product">
</form:form>
