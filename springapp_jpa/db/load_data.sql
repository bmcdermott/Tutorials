...
INSERT INTO products (id, description, long_description, price) values(NULL, 'NewProduct5', 'This item is NewProduct5', 105.00);
INSERT INTO products (id, description, long_description, price) values(NULL, 'NewProduct6', 'This item is NewProduct6', 106.00);
...
INSERT INTO products (id, description, long_description, price) values(NULL, 'NewProduct4', 'This item is NewProduct4', 104.00);
...
INSERT INTO components (id, description, long_description, product_id)
select NULL, 'New Component 6A', 'New Component 6A',  id from products
where description = 'NewProduct6';
INSERT INTO components (id, description, long_description, product_id)
select NULL, 'New Component 6B', 'New Component 6B',  id from products
where description = 'NewProduct6';
INSERT INTO components (id, description, long_description, product_id)
select NULL, 'New Component 6C', 'New Component 6C',  id from products
where description = 'NewProduct6';
INSERT INTO components (id, description, long_description, product_id)
select NULL, 'New Component 6D', 'New Component 6D',  id from products
where description = 'NewProduct6';
